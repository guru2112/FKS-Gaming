    ...
    <footer className="py-10 relative overflow-hidden bg-[#0a0a12]/80 backdrop-blur-xl border-t border-white/15">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex justify-center gap-4 mb-6">
          <a href="https://instagram.com/jks_arena" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full border border-white/10 bg-white/5 hover:bg-[#ff6b35] text-white transition-all duration-300 shadow-sm hover:shadow-[#ff6b35]/20 hover:scale-110">
